...
const FlyingWithEpipensNorthAmerica = () => {
  ...
  const pageDescription = "Clear guidance for traveling in the United States, Canada and Mexico with EpiPens and prescription medicines. Airport screening rules, airline expectations, and a practical packing checklist.";
