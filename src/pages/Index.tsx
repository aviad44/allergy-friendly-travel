  ...
  return <div className="min-h-screen bg-gray-50 w-full">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-white shadow-sm w-full">
        <div className="container mx-auto px-4 py-3 flex justify-between items-center">
          <Link to="/" aria-label="Return to homepage" className="flex items-center gap-3 text-2xl font-display font-bold text-amber-300 hover:text-amber-400 transition-colors">
            <img 
