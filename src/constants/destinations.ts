...
export const DESTINATION_IMAGES: Record<string, string> = {
  // Direct hardcoded paths for problematic destinations
  ...
  'crete': "https://images.unsplash.com/photo-1469796466635-455ede028aca",
  ...
  // Standard Unsplash photo IDs for other destinations
