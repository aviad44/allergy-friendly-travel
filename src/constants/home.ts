export const HOME_CONTENT = {
  ...
  hero: {
    ...
    description: "Discover accommodations that cater to your specific needs and enjoy worry-free travels. Our curated selection ensures your safety and comfort."
  },
  featured: {
  ...
  assistant: {
    title: "Need Personalized Recommendations?",
    description: "Our AI assistant can help you find the perfect hotel based on your specific needs and allergies."
  }
};