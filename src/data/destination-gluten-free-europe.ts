...
export const glutenFreeEuropeContent: DestinationContent = {
  ...
  hotels: [
    {
      ...
      features: [
        ...
        "🍽️ Specialized gluten-free menus",
        "👨‍🍳 Staff trained in celiac awareness"
      ],
    ...
    },
    {
      ...
      address: "Provença, 279, 08037 Barcelona, Spain",
      features: [
        "⭐ 3-star boutique hotel",
        "🥐 In-house gluten-free bakery",
    ...
    },
    {
      ...
      features: [
        ...
        "🍽️ Gluten-free options at breakfast",
        "🗣️ Staff trained to handle dietary requests"
      ],
    ...
    },
    {
      ...
      address: "Laimer Str. 40, 80639 München, Germany",
      features: [
        "⭐ 3-star family-run hotel",
        "🍳 Custom gluten-free breakfast",
        "📝 Staff knowledgeable about celiac disease"
      ],
    ...
    },
    {
      ...
      features: [
        ...
        "🥐 Labeled gluten-free breakfast items",
        "🍽️ Staff knowledgeable about local GF restaurants"
      ],
  ...
  languageTable: {
    ...
    rows: [
      ["I have celiac disease", "Ho la celiachia", "Tengo enfermedad celíaca", "J'ai la maladie cœliaque", "Ich habe Zöliakie", "Ik heb coeliakie"],
      ...
      ["Is this gluten-free?", "È senza glutine?", "¿Es sin gluten?", "Est-ce sans gluten?", "Ist das glutenfrei?", "Is dit glutenvrij?"],
      ["Cross-contamination", "Contaminazione incrociata", "Contaminación cruzada", "Contamination croisée", "Kreuzkontamination", "Kruisbesmetting"],
      ["Separate preparation", "Preparazione separata", "Preparación separada", "Préparation séparée", "Separate Zubereitung", "Aparte bereiding"],
      ["Gluten-free menu", "Menu senza glutine", "Menú sin gluten", "Menu sans gluten", "Glutenfreies Menü", "Glutenvrij menu"]
    ]
  }
};
