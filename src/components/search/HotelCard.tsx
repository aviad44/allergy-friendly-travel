...
export const HotelCard: React.FC<HotelCardProps> = ({
  ...
  return <div className="bg-white rounded-lg shadow-md border border-gray-200 overflow-hidden">
      <div className="p-5">
        ...
        {hotel.location && <div className="flex items-center text-gray-500 text-sm mb-3">
            <a href={getGoogleMapsUrl(cleanHotelName, hotel.location)} target="_blank" rel="noopener noreferrer" className="flex items-center hover:text-primary">
        ...
        {/* Guest Review */}
        {hotel.reviews && hotel.reviews.length > 0 && <div className="mb-4 bg-gray-50 p-3 rounded-md">
            <p className="text-sm text-gray-600 italic">"{hotel.reviews[0]}"</p>
          </div>}
        
        {/* Allergy Amenities Tags */}
        <div className="flex flex-wrap gap-2 mb-4">
          {hotel.allergyAmenities && hotel.allergyAmenities.map((amenity, index) => <div key={index} className="flex items-center text-xs text-teal-700 bg-teal-50 px-2 py-1 rounded-full">
              <span className="text-teal-600 mr-1">✓</span>
              <span className="\u05D1\u05D9\u05E7\u05E9\u05EA\u05D9 \u05DC\u05D4\u05E1\u05D9\u05E8 \u05D0\u05EA \u05D4\u05E8\u05DB\u05D9\u05D1 \u05D4\u05D6\u05D4 \u05DE\u05DB\u05DC \u05D4\u05E1\u05D8\u05E8\u05D9\u05E4\u05D9\u05DD.\n\u05D1\u05E0\u05D5\u05E1\u05E3, \u05D7\u05DC\u05E7 \u05DE\u05D4\u05E1\u05D8\u05E8\u05D9\u05E4\u05D9\u05DD \u05DE\u05EA\u05D7\u05D9\u05DC\u05D9\u05DD \u05D1-additional safety information. \u05D6\u05D4 \u05D1\u05D0\u05D2 \u05DB\u05D9 \u05D4\u05E1\u05D8\u05E8\u05D9\u05E4 \u05E6\u05E8\u05D9\u05DA \u05DC\u05D4\u05EA\u05D7\u05D9\u05DC \u05D1\u05E9\u05DD \u05DE\u05DC\u05D5\u05DF. \u05DB\u05DF \u05D0\u05E9\u05DE\u05D7 \u05E9\u05EA\u05E1\u05D9\u05E8 \u05D0\u05EA \u05E8\u05DB\u05D9\u05D1 \u05D4\u05E1\u05D9\u05E0\u05D5\u05DF: SORT BY ">{amenity.text}</span>
            </div>)}
        </div>
        
        {/* Action buttons */}
        <div className="flex flex-wrap gap-3 mt-4 pt-3 border-t">
          {hotel.url ? <Button className="flex-1 bg-teal-600 hover:bg-teal-700 text-white text-sm h-9" onClick={() => window.open(hotel.url, "_blank")}>
              Book Now
              <ExternalLink className="h-3.5 w-3.5 ml-1.5" />
            </Button> : null}
          
          {onViewDetails && <Button variant="outline" className="flex-1 border-teal-600 text-teal-600 hover:bg-teal-50 text-sm h-9" onClick={onViewDetails}>
              View Details
            </Button>}
        </div>
      </div>
